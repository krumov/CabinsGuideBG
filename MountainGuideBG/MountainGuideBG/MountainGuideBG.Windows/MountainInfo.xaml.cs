...
namespace MountainGuideBG
{
    ...
    /// </summary>
    public sealed partial class MountainInfo : Page
    {
        ...
        private void ViewCabinsButton_Click(object sender, RoutedEventArgs e)
        {
            var mountain = this.DefaultViewModel["Item"];
